...
print(y.grad, y.grad_fn)  # >>> None, <AddBackward0 object at 0x11b082ef0>

print("#" * 50, 3)

# Make the output scalar
L = y.mean()
print(L)  # >>> tensor(9., grad_fn=<MeanBackward0>)
print(L.shape)  # >>> torch.Size([])
print(L.grad, L.grad_fn)  # >>> None, <MeanBackward0 object at 0x11b082ef0>
